...
bool CPythonNetworkStream::RecvCharacterAdditionalInfo()
{
	...
	if(kNetActorData.m_dwVID == chrInfoPacket.dwVID)
	{
		...
		{
			if (kNetActorData.m_dwRace > 34000 && kNetActorData.m_dwRace < 35000 || kNetActorData.m_dwRace > 20100 && kNetActorData.m_dwRace < 20125 || kNetActorData.m_dwRace > 20201 && kNetActorData.m_dwRace < 20270)
			{
