...
bool PackInitialize(const char* c_pszFolder)
{
	...
	CEterPackManager::Instance().SetSearchMode(CEterPackManager::SEARCH_PACK_FIRST ? !LOAD_FROM_D_PATH : CEterPackManager::SEARCH_FILE_FIRST);

	CSoundData::SetPackMode();

	CEterPackManager::Instance().RegisterPack("pack/costume", "*");
	...
	CEterPackManager::Instance().RegisterPack("pack/map_dungeon", "*");
	CEterPackManager::Instance().RegisterPack("pack/map_empire", "*");
	CEterPackManager::Instance().RegisterPack("pack/map_event", "*");
	CEterPackManager::Instance().RegisterPack("pack/map_guild", "*");
	CEterPackManager::Instance().RegisterPack("pack/map_patch1", "*");
	CEterPackManager::Instance().RegisterPack("pack/map_patch2", "*");
	CEterPackManager::Instance().RegisterPack("pack/map_patch3", "*");
	...
	CEterPackManager::Instance().RegisterPack("pack/pc_assassin", "*");
	CEterPackManager::Instance().RegisterPack("pack/pc_common", "*");
	CEterPackManager::Instance().RegisterPack("pack/pc_shaman", "*");
	CEterPackManager::Instance().RegisterPack("pack/pc_sura", "*");
	CEterPackManager::Instance().RegisterPack("pack/pc_warrior", "*");
#ifdef ENABLE_WOLFMAN
	CEterPackManager::Instance().RegisterPack("pack/pc_wolfman", "*");
#endif
